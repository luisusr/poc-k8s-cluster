...
**UPDATE:** Se ha resuelto el bug a partir de la version 1.20.2 y se vuelven a mostrar las metricas de maquina por lo que ya no es necesario el despliegue del compoennte adicional
